            ...
            <xsl:if test="@paid='true'">
                ...
                <xsl:for-each select="person">
                    <DIV style="color:black; font-size:20">
                        <xsl:text>Идентификационный код:
                        </xsl:text>
                    </DIV>
                    <DIV style="color:blue;font-weight:bold; font-size:20; display:inline">
